...
public class TestLongMaxHeap {
    ...
    public void test_defaultFactoryMethod_createsAnArrayOfTenForZeroSizeHeap() throws ClassNotFoundException, NoSuchFieldException, IllegalAccessException {
        // given
        LongMaxHeap heap = LongMaxHeap.newHeap();
        ...
        Object value = ReflectionUtils.getFieldValueOf(heap, LongMaxHeap.class.getCanonicalName(), HEAP_ELEMENTS_FIELD_NAME);
    ...
    public void test_factoryMethodWithInitialCapacity_createsAnArrayWithZeroSizeHeap() throws ClassNotFoundException, NoSuchFieldException, IllegalAccessException {
        // given
        LongMaxHeap heap = LongMaxHeap.newHeap(20);
    ...
    public void test_factoryMethodWithArray_createsAHeapWithTheSameElements() throws ClassNotFoundException, NoSuchFieldException, IllegalAccessException {
        ...
        long[] elements = (long[]) ReflectionUtils.getFieldValueOf(heap, LongMaxHeap.class.getCanonicalName(), HEAP_ELEMENTS_FIELD_NAME);
    ...
    public void test_extractRemovesTheElement() throws IllegalAccessException, NoSuchFieldException, ClassNotFoundException {
        ...
        long[] elementsBefore = (long[]) ReflectionUtils.getFieldValueOf(heap, LongMaxHeap.class.getCanonicalName(), HEAP_ELEMENTS_FIELD_NAME);
        ...
        long[] elementsAfter = (long[]) ReflectionUtils.getFieldValueOf(heap, LongMaxHeap.class.getCanonicalName(), HEAP_ELEMENTS_FIELD_NAME);
