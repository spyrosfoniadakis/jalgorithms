...
public class TestFloatKeyedMaxHeap {
    ...
    public void test_defaultFactoryMethod_createsAnArrayOfTenForZeroSizeHeap() throws ClassNotFoundException, NoSuchFieldException, IllegalAccessException {
        // given
        FloatKeyedMaxHeap heap = FloatKeyedMaxHeap.newHeap();
        ...
        Object value = ReflectionUtils.getFieldValueOf(heap, FloatKeyedMaxHeap.class.getCanonicalName(), HEAP_ELEMENTS_FIELD_NAME);
    ...
    public void test_factoryMethodWithInitialCapacity_createsAnArrayWithZeroSizeHeap() throws ClassNotFoundException, NoSuchFieldException, IllegalAccessException {
        // given
        FloatKeyedMaxHeap<String> heap = FloatKeyedMaxHeap.newHeap(20);
    ...
    public void test_factoryMethodWithArray_createsAHeapWithTheSameElements() throws ClassNotFoundException, NoSuchFieldException, IllegalAccessException {
        ...
        // when
        FloatKeyedMaxHeap<Person> heap = FloatKeyedMaxHeap.from(elements);
        ...
        FloatKeyedElement<Person>[] data = (FloatKeyedElement<Person>[]) ReflectionUtils.getFieldValueOf(heap, FloatKeyedMaxHeap.class.getCanonicalName(), HEAP_ELEMENTS_FIELD_NAME);
    ...
    public void test_extractRemovesTheElement() throws IllegalAccessException, NoSuchFieldException, ClassNotFoundException {
        ...
        FloatKeyedElement<Person>[] elementsBefore = (FloatKeyedElement<Person>[]) ReflectionUtils.getFieldValueOf(heap, FloatKeyedMaxHeap.class.getCanonicalName(), HEAP_ELEMENTS_FIELD_NAME);
        ...
        FloatKeyedElement<Person>[] elementsAfter = (FloatKeyedElement<Person>[]) ReflectionUtils.getFieldValueOf(heap, FloatKeyedMaxHeap.class.getCanonicalName(), HEAP_ELEMENTS_FIELD_NAME);
    ...
    public void test_subsequentInsertionsIncreasesTheSizeByOneEachTime() throws IllegalAccessException, NoSuchFieldException, ClassNotFoundException {
        // given
        FloatKeyedMaxHeap<Person> heap = FloatKeyedMaxHeap.newHeap();
    ...
    public void test_parentElementIsLargerThanTheChildElements() throws IllegalAccessException, NoSuchFieldException, ClassNotFoundException {
        ...
        FloatKeyedMaxHeap<Person> heap = FloatKeyedMaxHeap.from(inputElements);
        FloatKeyedElement<Person>[] elements = ( FloatKeyedElement<Person>[]) ReflectionUtils.getFieldValueOf(heap, FloatKeyedMaxHeap.class.getCanonicalName(), HEAP_ELEMENTS_FIELD_NAME);
