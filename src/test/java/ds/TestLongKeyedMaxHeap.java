...
public class TestLongKeyedMaxHeap {
    ...
    public void test_defaultFactoryMethod_createsAnArrayOfTenForZeroSizeHeap() throws ClassNotFoundException, NoSuchFieldException, IllegalAccessException {
        // given
        LongKeyedMaxHeap heap = LongKeyedMaxHeap.newHeap();
        ...
        Object value = ReflectionUtils.getFieldValueOf(heap, LongKeyedMaxHeap.class.getCanonicalName(), HEAP_ELEMENTS_FIELD_NAME);
    ...
    public void test_factoryMethodWithInitialCapacity_createsAnArrayWithZeroSizeHeap() throws ClassNotFoundException, NoSuchFieldException, IllegalAccessException {
        // given
        LongKeyedMaxHeap<String> heap = LongKeyedMaxHeap.newHeap(20);
    ...
    public void test_factoryMethodWithArray_createsAHeapWithTheSameElements() throws ClassNotFoundException, NoSuchFieldException, IllegalAccessException {
        ...
        // when
        LongKeyedMaxHeap<Person> heap = LongKeyedMaxHeap.from(elements);
        ...
        LongKeyedElement<Person>[] data = (LongKeyedElement<Person>[]) ReflectionUtils.getFieldValueOf(heap, LongKeyedMaxHeap.class.getCanonicalName(), HEAP_ELEMENTS_FIELD_NAME);
    ...
    public void test_extractRemovesTheElement() throws IllegalAccessException, NoSuchFieldException, ClassNotFoundException {
        ...
        LongKeyedElement<Person>[] elementsBefore = (LongKeyedElement<Person>[]) ReflectionUtils.getFieldValueOf(heap, LongKeyedMaxHeap.class.getCanonicalName(), HEAP_ELEMENTS_FIELD_NAME);
    ...
    public void test_subsequentInsertionsIncreasesTheSizeByOneEachTime() throws IllegalAccessException, NoSuchFieldException, ClassNotFoundException {
        // given
        LongKeyedMaxHeap<Person> heap = LongKeyedMaxHeap.newHeap();
    ...
    public void test_parentElementIsLargerThanTheChildElements() throws IllegalAccessException, NoSuchFieldException, ClassNotFoundException {
        ...
        LongKeyedMaxHeap<Person> heap = LongKeyedMaxHeap.from(inputElements);
        LongKeyedElement<Person>[] elements = ( LongKeyedElement<Person>[]) ReflectionUtils.getFieldValueOf(heap, LongKeyedMaxHeap.class.getCanonicalName(), HEAP_ELEMENTS_FIELD_NAME);
