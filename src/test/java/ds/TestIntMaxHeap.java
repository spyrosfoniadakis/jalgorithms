...
public class TestIntMaxHeap {
    ...
    public static final String INT_MAX_HEAP_CLASS_NAME = "ds.IntMaxHeap";
    ...
    public void test_defaultFactoryMethod_createsAnArrayOfTenForZeroSizeHeap() throws ClassNotFoundException, NoSuchFieldException, IllegalAccessException {
        ...
        Object value = ReflectionUtils.getFieldValueOf(heap, INT_MAX_HEAP_CLASS_NAME, HEAP_ELEMENTS_FIELD_NAME);
    ...
    public void test_factoryMethodWithArray_createsAHeapWithTheSameElements() throws ClassNotFoundException, NoSuchFieldException, IllegalAccessException {
        ...
        int[] elements = (int[]) ReflectionUtils.getFieldValueOf(heap, INT_MAX_HEAP_CLASS_NAME, HEAP_ELEMENTS_FIELD_NAME);
    ...
    public void test_extractRemovesTheElement() throws IllegalAccessException, NoSuchFieldException, ClassNotFoundException {
        ...
        int[] elementsBefore = (int[]) ReflectionUtils.getFieldValueOf(heap, INT_MAX_HEAP_CLASS_NAME, HEAP_ELEMENTS_FIELD_NAME);
        ...
        int[] elementsAfter = (int[]) ReflectionUtils.getFieldValueOf(heap, INT_MAX_HEAP_CLASS_NAME, HEAP_ELEMENTS_FIELD_NAME);
    ...
    public void test_parentElementIsLargerThanTheChildElements() throws IllegalAccessException, NoSuchFieldException, ClassNotFoundException {
        ...
        while(true){
            ...
            System.out.println(String.format("candidate parent: %d, left: %d, right: %d", parentIndex, leftIndex, rightIndex));
